package com.dkatalis.assessment.optimalpath.util;
...
public class Spf4jConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Spf4jConfig.class);
    ...
    public static MeasurementRecorder getMeasurementRecorder(Object forWhat) {
        ...
        return RecorderFactory.createScalableQuantizedRecorder(forWhat, unitOfMeasurement, sampleTimeMillis, factor,
